...
from my_util.wordCloud import engCloud, hanCloud,sports_wordCloud
...
def text():
    ...
    if request.method == 'GET':
        ...
        return render_template('text_res.html', menu=menu, weather=get_weather_main(),
...
def sports_news():
    ...
    mtime = int(os.stat(img_file).st_mtime)
    return render_template('sports_res.html', menu=menu, weather=get_weather_main(),
                            mtime=mtime)
